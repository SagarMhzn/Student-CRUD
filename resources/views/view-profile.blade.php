                            ...
                            <div>
                               ...
                               <div class="student_profile" style="display:flex">
                                    ...
                                    <div class="student-image" style="margin:2rem">
                                        ...
                                        <img src="{{  url('public/Image/'.$data->image)}}"  width="500px" height="300px" style="object-fit: cover"/>
                                    ...
                                    <div class="student_info" style="margin:2rem">
                                        ...
                                        <div>
                                        <button class="edit-student-details btn btn-warning"><a href="/students-edit/{{ $data->id }}" style="text-decoration: none;color:white">Edit</a></button>
                                        <button class="delete-student-details btn btn-danger"><a href="/students-delete/{{ $data->id }}" style="text-decoration: none;color:white">Delete</a></button></td>
                                        </div>
                                    </div>
